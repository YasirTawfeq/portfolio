         ...
         <p className="text-xl md:text-2xl lg:text-3xl font-mono  text-white">Hello, I'm <span style={{color:"#FF1E00"}} >Yasir Tawfeq</span>.<br />
          ...
          <div className="flex justify-center " >
            <AnchorLink  href="#about" >
              <motion.a initial={{y:60,opacity:0}} whileInView={{y:0,opacity:1}} transition={{duration:0.5,delay:0.5}} className=" flex justify-center bg-none hover:bg-[#FF1E00] transform duration-200 hover:border-[#FF1E00] border-2 p-0.5 lg:p-2 px-2 lg:px-5 mx-1  m-4 text-white  text-sm lg:text-lg border-white rounded-sm " >View my work</motion.a> 
            </AnchorLink>
           <motion.button initial={{y:60,opacity:0}} whileInView={{y:0,opacity:1}} transition={{duration:1.2,delay:0.9}} onClick={() =>downloadImage(require('../imgs/yasir.png'))}  className=" flex justify-center bg-none hover:bg-[#FF1E00] transform duration-200 hover:border-[#FF1E00] border-2 p-0.5 lg:p-2 px-2 lg:px-5   m-4 text-white  text-sm lg:text-lg border-white rounded-sm ">
             Download CV
           </motion.button>
          </div>
