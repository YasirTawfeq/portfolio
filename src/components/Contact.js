...
function Contact() {
   ...
   const notify = () =>{toast.success('The message was successfully', {
                       position: "top-center",
                       autoClose: 5000,
      ...
      <div className="bg-[#383838]" >
         ...
         <div className="bg-[#383838] m-0 flex justify-center">
            ...
            <form onSubmit={sendEmail} className="flex flex-col justify-center w-96 pb-8 pt-2 lg:m-0 mx-4 "  >
                <input name="user_name" className=" bg-gray-700 p-2 text-gray-100  mt-1 " type="text" placeholder="Name" />
                <input name="user_email" className=" bg-gray-700 p-2 text-gray-100  mt-1 " type="email" placeholder="Email" />
                <textarea name="message" className=" bg-gray-700 p-2 text-gray-100  mt-1 " rows="5" cols="33" placeholder="Write your message here..." ></textarea>
                <button className=" bg-gray-700 p-2 mt-1 text-gray-100 hover:bg-gray-500 transform duration-300 " onClick={notify} type="submit"  >Send</button>  
            </form>
