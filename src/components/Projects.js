...
function Projects() {
  ...
  <div className="bg-gray-100">
     <motion.h1 initial={{x:-350,opacity:0}} whileInView={{x:0,opacity:1}} transition={{duration:2}} id="project" className=" my-16 text-3xl lg:text-4xl font-bold pt-8 text-center text-[#FF1E00] ">PROJECTS</motion.h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-0 md:px-20 md:py-10">
       
        <motion.div initial={{x:-100,opacity:0}} whileInView={{x:0,opacity:1}} transition={{delay:0.2,duration:1}} className=" h-64 relative m-1 group transform  ">
        ...
        <motion.div initial={{x:-100,opacity:0}} whileInView={{x:0,opacity:1}} transition={{delay:0.4,duration:1}} className=" h-64 relative m-1 group transform  ">
        ...
        <motion.div initial={{x:-100,opacity:0}} whileInView={{x:0,opacity:1}} transition={{delay:0.8,duration:1}} className=" h-64 relative m-1 group transform  ">
        ...
        <motion.div initial={{x:-100,opacity:0}} whileInView={{x:0,opacity:1}} transition={{delay:1.2,duration:1}} className=" h-64 relative m-1 group transform  ">
        ...
        <motion.div initial={{x:-100,opacity:0}} whileInView={{x:0,opacity:1}} transition={{delay:1.4,duration:1}} className=" h-64 relative m-1 group transform  ">
        ...
        <motion.div initial={{x:-100,opacity:0}} whileInView={{x:0,opacity:1}} transition={{delay:1.8,duration:1}} className=" h-64 relative m-1 group transform  ">
